...
Recipe cache shard for **[foodrecipes.page](https://foodrecipes.page)** — AI-generated recipes whose slug starts with **the letter 'u'**.
...
```
https://cdn.jsdelivr.net/gh/foodrecipes-page/recipes-u@main/recipes/<cuisine>/<diet>/<slug>.json
```
